var invitation = ['Sohail', 'Asif', 'Khaliq', 'Raheel'];
...
for (var i = 2; i < invitation.length; i++) {
    // let new_list = invitation.pop()
    console.log("Sorry ".concat(invitation[i], " you are no longer invied for a dinner."));
}
invitation.pop();
invitation.pop();
invitation.pop();
...
invitation.forEach(function (name) {
    console.log("Dear Mr. ".concat(name, " You Are Still Invited For A dinner ."));
});
invitation.pop();
invitation.pop();
console.log(invitation);
